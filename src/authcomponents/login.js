    ...
    async function handleSubmit(e) {
        ...
        if (password.length < 8) {
            ...
            try {
                ...
                let result = await fetch("https://dall-e-backend-3wtv.onrender.com/user/login", {
                    method: "POST",
                ...
                else if (updatedResult.resp === false && updatedResult.msg === "not exist") {
                    setResp(true);
                    setMsg("Email does not exist");
                }
                else if (updatedResult.resp === false && updatedResult.msg === "incorrect password") {
                    setResp(true);
            ...
            <div className="container">
                <div className="row d-flex justify-content-center align-items-center min-vh-100 align-content-center">
                    <div className="col-md-8 col-lg-5 mx-auto">
                        <p className="title fw-bold m-2 mb-4 h2 text-center">Welcome back !</p>
                        <div className="signup">
                            ...
                            <p className="text-center forgot-pass" onClick={() => navigate("/forgot-password")}>Forgot password ?</p>
                            <p className="text-center m-3"><small className="acc">Don't have an account ?</small><span className="login" onClick={() => navigate("/signup")}>Signup</span></p>
